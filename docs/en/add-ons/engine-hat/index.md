...
See the [Getting Started](getting-started/index.md) page for hardware installation and connection instructions.

The [Hardware](hardware/index.md) page contains more detailed information about the Engine Hat hardware.
