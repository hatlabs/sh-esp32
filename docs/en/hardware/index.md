...
<figcaption>Functional blocks of SH-ESP32.</figcaption>
</figure>
...
<figcaption>SH-ESP32 connectors.</figcaption>
</figure>
...
Circled numbers are by default used by other peripherals and have to be connected by setting the solder jumpers (see Section "[Customizing GPIO assignments](#customizing-gpio-assignments)" for more information).
...
<figcaption>SH-ESP32 proto board area.</figcaption>
</figure>
...
These connections may be altered by modifying the jumpers as described in Section "[Customizing GPIO assignments](#customizing-gpio-assignments)".
...
<figcaption>Resistor jumpers on the top layer. To disconnect the GPIO pin from any peripheral, unsolder the respective jumper.</figcaption>
</figure>
