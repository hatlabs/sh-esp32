...
![SH-ESP32 top](media/sh-esp32_r2.0.0_top_render.jpg "SH-ESP32 Rev. 2 top view"){ width="60%" }
...
Ready-made CE-certified SH-ESP32 boards can be purchased from [Hat Labs Oy](https://hatlabs.fi).
