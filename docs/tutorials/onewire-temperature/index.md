...
If you want to connect the apparatus to NMEA 2000, add an M12 panel connector as described in the [NMEA 2000 USB gateway tutorial](../nmea2000-gateway/index.md).
...
Then mount the power (or NMEA 2000) connector and connect everything to the board to [the respective connectors](../../hardware/index.md#connectors).
...
Prerequisites are the same as for the [NMEA 2000 gateway](../nmea2000-gateway/index.md): you need to have Visual Studio Code and PlatformIO as well as drivers for the CH340 USB serial chip. 
